export const BASE_URL = import.meta.env.VITE_BASE_URL || 'https://infinitocomics-68cr.onrender.com';
...
export const SHOP_BASE_URL = import.meta.env.VITE_SHOP_BASE_URL || 'https://infinitohq.com/shop/';
