...
const InfinitoCarousel = ({ researchPaper, isLoading }) => {
  ...
  return (
    <div style={{ background: "#f3f4f6" }}>
      ...
      {/* Gray spacer — hidden on mobile (no negative margin trick needed) */}
      <div className="hidden md:block" style={{ height: "70px", position: "relative", zIndex: 0 }} />
      ...
      <div style={{ background: "#000", position: "relative" }}>
        ...
        <div style={{
          ...
          {/* LEFT: text content */}
          <div style={{
            flex: "0 0 100%", maxWidth: "100%",   /* full width on mobile */
            padding: "2rem 0 1.5rem",
          }}
            className="md:flex-none"
            // on md+ override to 53%
          >
            <style>{`
              @media (min-width: 768px) {
                .carousel-left { flex: 0 0 53% !important; max-width: 53% !important; padding: 2.5rem 2rem 3rem 0 !important; }
                .carousel-right { flex: 0 0 47% !important; max-width: 47% !important; margin-top: -70px !important; margin-bottom: -2rem !important; }
              }
            `}</style>
            <div className="carousel-left" style={{ flex: "0 0 100%", maxWidth: "100%", padding: "2rem 0 1.5rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", marginBottom: "1.3rem", flexWrap: "wrap", gap: "4px" }}>
                <span style={{
                  ...
                  fontSize: "clamp(1.6rem, 5vw, 3rem)", letterSpacing: "0.05em",
          ...
          <div className="carousel-right" style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontWeight: 800, fontSize: "clamp(1.2rem, 3vw, 1.6rem)", color: "#111", lineHeight: 1.2, marginBottom: "0.5rem" }}>
                {paper.title}
              </h2>
